...
ALLOWED_TRAINING_TERM_HITS = {
    ...
    (Path("scripts/train_synthetic_whatsapp_pattern_baseline.py"), "TfidfVectorizer"),
    (Path("scripts/train_synthetic_whatsapp_pattern_baseline.py"), "LogisticRegression"),
    (Path("scripts/train_synthetic_whatsapp_pattern_baseline.py"), ".fit("),
    (Path("scripts/train_synthetic_whatsapp_pattern_baseline.py"), "sklearn"),
    (Path("scripts/train_transcript_nlp_local_research_baseline.py"), "TfidfVectorizer"),
    (Path("scripts/train_transcript_nlp_local_research_baseline.py"), "LogisticRegression"),
    (Path("scripts/train_transcript_nlp_local_research_baseline.py"), ".fit("),
    (Path("scripts/train_transcript_nlp_local_research_baseline.py"), "sklearn"),
