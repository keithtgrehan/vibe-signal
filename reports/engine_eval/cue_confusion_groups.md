...
- Missing within group: `{'ambiguity': 79}`
- Substitutions: `{}`
- Co-fires: `{'ambiguity+unclear_ask': 79}`
...
- Unexpected within group: `{}`
- Missing within group: `{'contradiction_against_prior_message': 158}`
- Substitutions: `{}`
- Co-fires: `{}`
...
- Unexpected within group: `{}`
- Missing within group: `{'alignment': 79}`
- Substitutions: `{}`
...
- Unexpected within group: `{'directness': 790, 'specificity': 869, 'specificity_drop': 79}`
- Missing within group: `{}`
- Substitutions: `{}`
- Co-fires: `{'directness+specificity': 1316, 'specificity+specificity_drop': 237}`
...
- Unexpected within group: `{'answer_evasion_pattern': 337}`
...
- Unexpected within group: `{'boundary_pressure': 79, 'urgency': 337}`
- Missing within group: `{}`
- Substitutions: `{}`
