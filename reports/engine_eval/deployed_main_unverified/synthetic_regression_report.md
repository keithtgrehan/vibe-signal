...
- API regression pass rate: `99/100`
- Cue contract pass rate: `99/100`
- Evidence completeness rate: `99/100`
- Unsafe-output block rate: `99/100`
- Fallback correctness rate: `99/100`
- API transport failures: `1`
- Missing expected cue count: `3`
